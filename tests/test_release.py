...
class ReleaseTests(unittest.TestCase):
    def test_xpi_and_update_manifest(self):
        ...
        self.assertIn("anaxonda/uttermux-zotero", application["update_url"])
        self.assertEqual(application["strict_min_version"], "9.0")
        self.assertEqual(application["strict_max_version"], "10.0.*")
        ...
        self.assertEqual(update["applications"]["zotero"], {
            "strict_min_version": "9.0", "strict_max_version": "10.0.*"})
